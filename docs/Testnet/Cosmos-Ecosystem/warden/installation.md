...
### Faucet
You can get your test tokens by sending a message as `$request CUZDAN_ADRESI` to the `#🏗・chiado-faucet` channel on the [Discord](https://discord.gg/wardenprotocol) server.
